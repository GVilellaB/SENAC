document.querySelector(`#salvar`).addEventListener('click', () => {
    ...
    let json = { nome: nome, genero: genero, dtNascimento: nascimento, pais: pais, email: email, senha: senha, foto: foto, admin: admin };
    addlinha(json);
...
function addlinha(usuario) {
    ...
    tr.innerHTML = `<td><img src="./dist/img/user1-128x128.jpg" alt="Imagem do usuario" class="img-sm img-circle"></td>
    <td>${usuario.nome}</td>
    <td>${usuario.email}</td>
     <td>${usuario.admin}</td>
